...
from tensor.tensor.coordinate.system._system import Axis
from tensor.tensor.coordinate.system._system import CoordinateSystem


class TestCoordinateSystem:
    def test_init(self):
        a = CoordinateSystem(dimensions=3)
        assert len(a.axes) == 3
